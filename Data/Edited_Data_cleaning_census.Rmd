...
Census_2010 = Census_2010 %>% select(Label..Grouping., Label, X....Foreign.born, X....Total.population, X....Associate.s.degree, X....Bachelor.s.degree, X....Graduate.or.professional.degree, X....Naturalized.U.S..citizen, X....Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2011= Census_2011 %>% select(Label..Grouping., Label, X....Foreign.born, X....Total.population, X....Associate.s.degree, X....Bachelor.s.degree, X....Graduate.or.professional.degree, X....Naturalized.U.S..citizen, X....Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2012 = Census_2012 %>% select(Label..Grouping., Label, X....Foreign.born, X....Total.population, X....Associate.s.degree, X....Bachelor.s.degree, X....Graduate.or.professional.degree, X....Naturalized.U.S..citizen, X....Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2013 = Census_2013 %>% select(Label..Grouping., Label, X....Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2014 = Census_2014 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2015 = Census_2015 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen,X........Not.a.U.S..citizen)
...
#Select the columns of interests
Census_2016 = Census_2016 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
Census_2017 = Census_2017 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
# Select the columns of interest
Census_2018 = Census_2018 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
# Select the columns of interest
Census_2019 = Census_2019 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
# Select the columns of interest
Census_2020 = Census_2020 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
# Select the columns of interest
Census_2021 = Census_2021 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
# Select the columns of interest
Census_2022 = Census_2022 %>% select(Label..Grouping., Label, X........Foreign.born, X....Total.population, X........Associate.s.degree, X........Bachelor.s.degree, X........Graduate.or.professional.degree, X........Naturalized.U.S..citizen, X........Not.a.U.S..citizen)
...
```{r}
#Append all the dataset sand make a dataset named Census
...
columns_to_clean_and_convert_2 = c("Foreign_born", "Associate_degree", "Bachelor_degree", "Graduate_or_professional_degree")
...
columns_to_check = c("County", "State", "Foreign_born", "Associate_degree", "Bachelor_degree", "Graduate_or_professional_degree", "Year", "Rural")
...
```{r}
#Load the dataset X2012_F and name it Female_2012
Female_2012 = read.csv("C:/Msu applied economics/Advanced data analytics/Project/Data/Data/X2012_F.csv")
...
# Select the columns of interest
Female_2012 = Female_2012 %>% select(Label..Grouping., X....Females.15.years.and.over, X....Males.15.years.and.over)

# Create a new column named Year with 2012 values in each entry
Female_2012$Year= 2012

# Change variable names below
Female_2012 = Female_2012 %>%
  rename(Female = X....Females.15.years.and.over) %>% 
  rename(Male= X....Males.15.years.and.over) %>% 
  rename(County= Label..Grouping.)

# Create a sequence of row indices to keep odd rows
rows_to_keep = seq(1, nrow(Female_2012), by = 2)

# Subset the data frame to keep only the odd rows
Female_2012 = Female_2012[rows_to_keep, ]
```

```{r}
#Load the dataset X2016_F and name it Female_2016
Female_2016 = read.csv("C:/Msu applied economics/Advanced data analytics/Project/Data/Data/X2016_F.csv")
...
# Select the columns of interest
Female_2016 = Female_2016 %>% select(Label..Grouping., X....Females.15.years.and.over, X....Males.15.years.and.over)

# Create a new column named Year with 2016 values in each entry
Female_2016$Year= 2016

# Change the name of the variables below
Female_2016 = Female_2016 %>%
  rename(Female = X....Females.15.years.and.over) %>% 
  rename(Male= X....Males.15.years.and.over) %>% 
  rename(County= Label..Grouping.)
...
# Create a sequence of row indices to keep odd rows
rows_to_keep = seq(1, nrow(Female_2016), by = 2)

# Subset the data frame to keep only the odd rows
Female_2016 = Female_2016[rows_to_keep, ]
```

```{r}
#Load the dataset X2020_F and name it Female_2020
Female_2020 = read.csv("C:/Msu applied economics/Advanced data analytics/Project/Data/Data/X2020_F.csv")

# Create a new column indicating label of the values
Female_2020 = Female_2020 %>%
  mutate(Label = ifelse(grepl("Estimate$", Label..Grouping.), "Estimate", "Percent"))

# Select the columns of interest
Female_2020 = Female_2020 %>% select(Label..Grouping., X....Females.15.years.and.over, X....Males.15.years.and.over)

# Create a new column named Year with 2020 values in each entry
Female_2020$Year= 2020
...
# Create a sequence of row indices to keep odd rows
rows_to_keep = seq(1, nrow(Female_2020), by = 2)

# Subset the data frame to keep only the odd rows
Female_2020 = Female_2020[rows_to_keep, ]
```

```{r}
#Append all the datasets and make a dataset named Female
Female = bind_rows(Female_2012, Female_2016, Female_2020)
```
...
#Remove the word "county", from the county column
Female$County = gsub(" County", "", Female$County)

 #Remove !!Estimate from the State variable
Female$State = sub("!!Estimate", "", Female$State)

```

```{r}
#Create a new column or surrogate key in Female data named County_State_Year using County and Year column
Female$County_State_Year = paste(Female$County, Female$State, Female$Year, sep = "_")
```

```{r}
# Check for missing values in the entire data frame
missing_values <- sum(is.na(Female))
...
```{r}
# Remove punctuation from the "Female" and "Male" variables
Female$Female = gsub("[[:punct:]]", "", Female$Female)
Female$Male = gsub("[[:punct:]]", "", Female$Male)


#Convert"Female", "Male" to  numeric
Female= Female %>% 
...
```{r}
# Make all the character variables Uppercase
Female= Female %>% 
  mutate(County= toupper(County)) %>% 
  mutate(State= toupper(State)) %>% 
  mutate(County_State_Year= toupper(County_State_Year))
```

```{r}
# Create a new column 'Total Population' by summing 'Female' and 'Male'
Female$Total_population = Female$Female + Female$Male
```

```{r}
#Create a new variable Female_per which is ratio of Female population to Total population

Female$Female = (Female$Female / Female$Total)*100
...
#Left_join Census_percent and Election_main by County_State_Year
 merged_data_1=  merge(Census_percent, Election_main, by = c( "County_State_Year", "County", "Year", "State"), all.x=TRUE, all.y= TRUE)
...
merged_data_1 = distinct(merged_data_1, County_State_Year, .keep_all = TRUE)

#Left_join merged_data_1 and Female by County_State_Year, County, Year and State
 merged_data_2=  merge(merged_data_1, Female, by = c( "County_State_Year", "County", "Year", "State"), all.x=TRUE, all.y= TRUE)
 
 #Remove all the NA values 
merged_data_2 = na.omit(merged_data_2)


#Remove all the duplicates
Merged_data_2 = distinct(merged_data_2, County_State_Year, .keep_all = TRUE)
```

```{r}
#Create a new variable named Total_votes
merged_data_2= merged_data_2 %>% 
  mutate(Total_votes= Democrat_Votes + Republican_Votes)

#Create three new variables named Democrat_vote_share, Republican_vote_share and Vote_share_difference and name the merged_data_2 to main_data
main_data= merged_data_2 %>% 
  mutate(Democrat_vote_share= Democrat_Votes/ Total_votes) %>% 
  mutate(Republican_vote_share= Republican_Votes/ Total_votes) %>% 
  mutate(Vote_share_difference= Republican_vote_share - Democrat_vote_share)
```
